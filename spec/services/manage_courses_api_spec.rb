...
RSpec.describe 'Manage Courses API Service', type: :request do
  describe 'approving access requests' do
    ...
    it 'handles 401 correctly' do
      ...
      expect do
        MANAGE_COURSES_API.approve_access_request(id: 1)
      end.to raise_error ManageCoursesAPI::AccessRequestInternalFailure, /unauthorized/
    end
    ...
    it 'handles 404 correctly' do
      ...
      expect do
        MANAGE_COURSES_API.approve_access_request(id: 1)
      end.to raise_error ManageCoursesAPI::AccessRequestInternalFailure, /not found/
    end
    ...
    it 'handles network failure correctly' do
      ...
      expect do
        MANAGE_COURSES_API.approve_access_request(id: 1)
      end.to raise_error ManageCoursesAPI::AccessRequestInternalFailure, /Connection refused/
    end
    ...
    it 'handles unknown status code correctly' do
      ...
      expect do
        MANAGE_COURSES_API.approve_access_request(id: 1)
      end.to raise_error ManageCoursesAPI::AccessRequestInternalFailure, /unexpected response code 999/
    end
  end
